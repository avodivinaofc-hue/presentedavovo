...
export default function AuthenticSocialProofUS() {
    const testimonials = [
        {
            text: "I wasn't looking for anything. But this reading said exactly what I was going through.",
            author: "M."
        },
        {
            text: "I didn't hear what I wanted. I heard what I needed.",
            author: "A."
        },
        {
            text: "It made silence within me. And that was already an answer.",
            author: "L."
        }
    ]
        ...
        <section className="py-32 px-6 border-t border-authentic-gold/5 bg-authentic-black/80 relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto space-y-20 relative z-10">
                <div className="text-center">
                    ...
                    <h3 className="text-authentic-gray text-sm uppercase tracking-widest">Confidences</h3>
                </div>
